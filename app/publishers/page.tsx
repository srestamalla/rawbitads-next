      ...
      <main>
          ...
          <div className="container relative z-10">
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 grid grid-cols-2 gap-3">
                {payoutStats.map(({ value, label }, i) => (
                  <AnimateIn key={label} variant="right" delay={i * 80}>
                    <div className="rounded-2xl border border-white/15 bg-white/8 backdrop-blur-xl p-6 text-center">
        ...
        <section className="container py-24 lg:py-32">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {benefits.map(({ icon: Icon, title, desc }, i) => (
              <AnimateIn key={title} delay={i * 80} className="h-full">
                <HoverCard>
                  <article className="rounded-[1.75rem] glass p-7 flex gap-5 h-full">
          ...
          <div className="container">
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-3">
                {formats.map(({ icon: Icon, name, desc }, i) => (
                  <AnimateIn key={name} variant="right" delay={i * 70}>
                    <div className="rounded-2xl border border-ink-foreground/15 bg-ink-foreground/5 p-5 flex items-center gap-4">
        ...
        <section className="container py-24 lg:py-32">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {steps.map((step, i) => (
              <AnimateIn key={step.n} delay={i * 100} className="h-full">
                <HoverCard>
                  <article className="rounded-[1.75rem] glass p-7 h-full">
