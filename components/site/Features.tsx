...
const Features = () => (
  <section className="py-24 lg:py-32">
    <div className="container">
      <AnimateIn className="text-center max-w-5xl mx-auto mb-14">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        {features.map(({ title, desc, icon: Icon }, i) => (
          <AnimateIn key={title} delay={i * 80}>
            <article className="rounded-[1.75rem] border border-primary/12 bg-white/70 backdrop-blur-xl p-4 shadow-soft hover:-translate-y-1 hover:shadow-card transition-all duration-300 h-full">
