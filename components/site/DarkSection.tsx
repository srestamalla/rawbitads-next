    ...
    <div className="container">
      <div className="grid lg:grid-cols-12 gap-12 items-center mb-20">
        ...
        <AnimateIn variant="right" className="lg:col-span-7">
          <div className="rounded-[2rem] overflow-hidden aspect-[16/9] relative shadow-card">
            <img
      ...
      <div className="grid lg:grid-cols-12 gap-10 items-center border-t border-ink-foreground/20 pt-16">
        <AnimateIn variant="fade" className="lg:col-span-6">
        ...
        <div className="lg:col-span-6 grid sm:grid-cols-2 gap-6">
          {stats.map((s, i) => (
            <AnimateIn key={s.label} delay={i * 80}>
              <div className="border-l border-ink-foreground/20 pl-5 hover:border-l-primary/60 transition-colors duration-300">
          ...
          <AnimateIn delay={4 * 80} className="sm:col-span-2 mt-4">
